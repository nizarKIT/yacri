    ...
    var e = {
        ...
        3142: function (e, t, n) {
            ...
            function p(e, t) {
                return "object" == typeof e &&
                    ...
                    ? (console.warn(
                        ...
                        a.setStorefrontApiTrackingConsent(e, t || (() => { })))
            ...
            (t.analyticsProcessingAllowed = function () {
                ...
                (t.urlConsentParam = function () {
                    const e = d();
                    return `__cmpecs=${Object.entries(e)
                        .map(([e, t]) => [
                            a.transformDisplayNameToKey(e),
                            a.transformDisplaySchemaToConsent(t),
                        ])
                        .filter((e) => e[1] != i.ConsentValues.NO_VALUE)
                        .map((e) => e.join(""))
                        .join("")}`;
                });
        },
            ...
            (t.CONSENT_COOKIE_NAME = i),
                ...
                (t.setStorefrontApiTrackingConsent = function (e, t) {
                    ...
                    const a = {
                        ...
                        s = { v: o.CookieVersion, reg: "", con: { CMP: a } },
                        c = encodeURIComponent(JSON.stringify(s));
                    return (
                        r.writeCookie(i, e.rootDomain, 31536e6, c),
                        t(null),
                        new Promise((e, t) => { })
                    );
                }),
        ...
        8920: function (e, t, n) {
            ...
            function s() {
                ...
                return e[o.ConsentKeys.MARKETING] === o.ConsentValues.ACCEPTED &&
                    ...
                    ? o.DisplayConsentValues.ACCEPTED
                    : e[o.ConsentKeys.MARKETING] === o.ConsentValues.DECLINED ||
                        e[o.ConsentKeys.ANALYTICS] === o.ConsentValues.DECLINED
                        ? o.DisplayConsentValues.DECLINED
                        : o.DisplayConsentValues.NO_INTERACTION;
            }
            function c(e) {
                return e
                    ? u()
            ...
            function d() {
                return (
                    i.marketingProcessingAllowed() && i.analyticsProcessingAllowed()
                );
            }
            function p() {
                return i.saleOfDataRegion()
            ...
            function l() {
                return !1 === p()
                    ? o.DisplayConsentValues.DECLINED
                    : ((e = r.getCCPAConsentValue()),
                        r.validCookieDoesNotExist()
                            ? o.DisplayConsentValues.NO_VALUE
                            : e === o.ConsentValues.NO_VALUE
                                ? o.DisplayConsentValues.NO_INTERACTION
                                : r.transformConsentToDisplaySchema(e));
                var e;
            }
            (t.saleOfDataRegion = i.saleOfDataRegion),
                (t.GPCSignal = p),
                (t.doesMerchantSupportGranularConsent = function () {
                    return !0;
                }),
                (t.getCCPAConsent = l),
                (t.getLandingPageData = c),
                ...
                (t.setCCPAConsent = function (e, t) {
                    ...
                    return a.storefrontApiUpdateTrackingConsent(
                        { granular_consent: { sale_of_data: e } },
                        t
                    );
                }),
                    ...
                    if (
                        ((function (e) {
                            ...
                            if ("object" == typeof e) {
                                ...
                                const n = [
                                    o.ConsentDisplayKeys.MARKETING,
                                    o.ConsentDisplayKeys.ANALYTICS,
                                    o.ConsentDisplayKeys.PREFERENCES,
                                    o.ConsentDisplayKeys.SALE_OF_DATA,
                                    o.ConsentDisplayKeys.EMAIL,
                                    o.StorefrontApiConsentMetadata.ROOT_DOMAIN,
                                    o.StorefrontApiConsentMetadata.CHECKOUT_ROOT_DOMAIN,
                                    o.StorefrontApiConsentMetadata.STOREFRONT_ROOT_DOMAIN,
                                    o.StorefrontApiConsentMetadata.STOREFRONT_ACCESS_TOKEN,
                                    o.StorefrontApiConsentMetadata.HEADLESS_STOREFRONT,
                                    o.StorefrontApiConsentMetadata.IS_EXTENSION_TOKEN,
                                    o.StorefrontApiConsentMetadata.METAFIELDS,
                                ];
                                for (const e of t)
                                    if (!n.includes(e))
                                        throw TypeError(
                ...
                (t.shouldShowCCPABanner = function () {
                    return (
                        ...
                        i.saleOfDataRegion() &&
                        l() === o.DisplayConsentValues.NO_INTERACTION
                    );
                }),
                (t.shouldShowGDPRBanner = function () {
                    return (
                        i.shouldShowBanner() &&
                        s() === o.DisplayConsentValues.NO_INTERACTION
                    );
                }),
        ...
        1449: function (e, t) {
            ...
            function n(e, t = !1) {
                ...
                for (let t = 0; t < r.length; t++) {
                    const [n, o] = r[t].split("=");
                    if (e === decodeURIComponent(n))
                        return JSON.parse(decodeURIComponent(o));
                }
                if (
                    t &&
                    "_cmp_a" === e &&
                    !window.localStorage.getItem("cmp_a_fetched")
                )
                    return (
                        console.debug("_cmp_a missing"),
                        o(),
                        ...
                        const s = (function (e) {
                            return {
                                ...
                                firstPartyMarketingAllowed:
                                    e[o.DataProcessingPurpose.MARKETING],
        ...
        5461: function (e, t, n) {
            ...
            (t.ConsentKeys = o.ConsentKeys),
                ...
                (t.dispatchLoadedEvent = s.dispatchLoadedEvent),
                (t.analyticsProcessingAllowed = c.analyticsProcessingAllowed),
                (t.currentVisitorConsent = c.currentVisitorConsent),
                (t.marketingAllowed = c.marketingAllowed),
                (t.preferencesProcessingAllowed = c.preferencesProcessingAllowed),
                (t.saleOfDataAllowed = c.saleOfDataAllowed),
        ...
        5542: function (e, t, n) {
            ...
            function d(e) {
                ...
                return {
                    query: `query { consentManagement { cookies(${s.objectToGraphQL(
                        n
                    ...
                    l = {
                        headers: {
                            ...
                            [n.isExtensionToken
                                ...
                                : "x-shopify-storefront-access-token"]: s,
                        },
                        body: JSON.stringify(d(e)),
                        method: "POST",
                    };
                return fetch(`https://${p}/api/unstable/graphql.json`, l)
                    .then((e) => {
                    ...
                    .then((s) => {
                        const d = 31536e6,
                            ...
                            g = s.data.consentManagement.cookies.answersCookie,
                            v = s.data.consentManagement.cookies.landingPageCookie,
                            y = s.data.consentManagement.cookies.origReferrerCookie;
                        return (
                            r.writeCookie(i.CONSENT_COOKIE_NAME, f, d, h),
                            r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, f, d, g),
                            v &&
                            y &&
                            (r.writeCookie(c, f, p, v), r.writeCookie(u, f, p, y)),
                            _ !== f &&
                            (r.writeCookie(i.CONSENT_COOKIE_NAME, _, d, h),
                                r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, _, d, g),
                                v &&
                                y &&
                                (r.writeCookie(c, _, p, v), r.writeCookie(u, _, p, y))),
                            o.dispatchEvents(e),
                            void 0 !== t && t(null, s),
                            s
                        );
        ...
        6304: function (e, t) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.ConsentValues = { NO_VALUE: "", ACCEPTED: "1", DECLINED: "0" }),
                (t.CookieVersion = "2.1"),
        ...
        1930: function (e, t) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.15"),
                (t.storefrontAnalyticsSchemaIdValidation =
                ...
                p = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.loadGtagScript = function () {
                            var e = this.options;
                            window.gtag("set", "developer_id." + t.developerId, !0),
                        ...
                        var t = e.eventName,
                            ...
                            c = {
                                ...
                                payload: this.eventWithMetadata(
                                    t,
                                    a ? this.payloadWithCustomStorefrontMetadata(o) : o,
                                    n.s2sMetadata,
                                    i
                                ),
                            };
                            ...
                            i(
                                {
                                    ...
                                    asset_version_id:
                                        "c1258b47cccb7bc2aeeaeb253b8999e078bd2f6b",
                        ...
                        (t.prototype.loadTikTokScript = function (e) {
                            ...
                            (t.load = function (e) {
                                ...
                                (o.type = "text/javascript"),
                                    (o.async = !0),
                                    (o.src = n + "?sdkid=" + e + "&lib=ttq&type=trekkie");
            ...
            (t.metricsSchemaId = "trekkie_metrics/2.0"),
                ...
                (t.sendToBugsnag = function (e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "c1258b47cccb7bc2aeeaeb253b8999e078bd2f6b",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig)
        ...
        997: function (e, t) {
            ...
            (t.setMonorailRegion = function (e) {
                ...
                "shop_domain" === e && n
                    ? (o = n + "/.well-known/shopify/monorail/unstable/produce_batch")
                    : e in t.batchEndpoints && (o = t.batchEndpoints[e]);
            }),
                    ...
                    return (
                        ...
                        (e.prototype.logAssetContext = function (e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "c1258b47cccb7bc2aeeaeb253b8999e078bd2f6b",
                        ...
                        (e.prototype.track = function (e, t, n, o) {
                            void 0 === e && (e = ""), void 0 === t && (t = {});
                            var r = "Checkout One Page View" === e ? "Page View" : e,
                                i = this.getS2SEventId(r, t, n);
                            e instanceof Object && ((t = e), (e = ""));
                            for (
                                var a = {
                                    event: e,
                                    properties: this.constructTrackArgs(e, t, i),
                                    eventId: i.eventId,
                                    s2sMetadata: i.s2sMetadata,
                                ...
                                var d = u[c];
                                try {
                                    d.emitEventOrAwaitConsent("track", a);
                                } catch (e) {
                                    s.reportError("track", e);
                                }
                            }
                            return this.flushMonorailEventsIfLoaded(), i.eventId;
                        }),
        ...
        803: function (e, t, n) {
            ...
            const o = "sh",
                ...
                g = "checkout_address_info_submitted",
                v = "checkout_shipping_step_started",
        ...
        (function () {
            ...
            try {
                ...
                if (h) {
                    ...
                    var g = window[r],
                        v = (window.trekkie = new e.Tricorder(i, h, function () {
                            (window[r] = v),
                                (window._visit = {
                                    tag: function () { },
